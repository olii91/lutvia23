...
<head>
  ...
  <title>PENGGAPP | Pengaduan Masyarakat Application</title>
      ...
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div data-aos="fade-up" data-aos-delay="800">
            <a href="{{ url('/masyarakat/login')}}" class="btn-get-started scrollto">Laporkan!</a>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
            <p>
              <h3>PENGGAPP</h3> adalah sistem laporan pengaduan Masyarakat yang dibuat untuk memudahkan masyarakat untuk memberikan laporan atau informasi kepada pemerintah
            </p>
            <ul>
              <h3>Tujuan PENGGAPP</h3>
              ...
              <li><i class="ri-check-double-line"></i>Mempermudah masyarakat untuk berkomunikasi dengan pihak pemerintah terkait</li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <p>
              <h4></h4>merupakan komitmen  kami untuk melayani masyarakat. Dengan hadirnya sistem pelaporan pengaduan online ini, diharapkan setiap suara masyarakat bisa didengar dan ditindaklanjuti oleh pemerintah terkait.
            </p>
              ...
              <div class="row">
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p><strong>Pengguna</strong><br>DAFTAR pengguna PENGGAPP</p>
                  </div>
                </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>TATA CARA</h2>
          <p>Nah ini dia alur pelaporan yang ada website PENGGAPP</p>
        </div>
